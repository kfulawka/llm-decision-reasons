...
- **02_llms_analyses/**  
  ...
  *Note: This folder contains ~890 MB of output files across subjects.  
...
The relatively large size of the repository comes primarily from storing the complete set of LLM output files, which ensures reproducibility and allows full inspection of the analyses.
