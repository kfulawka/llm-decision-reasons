...
write.csv(d_demo, '00_data/csv_dat/demographics.csv', row.names = F)
...
write.csv(md, '00_data/csv_dat/choice_data.csv', row.names = F)
...
write.csv(d_text, '00_data/csv_dat/verbal_reports.csv', row.names = F)
...
write.csv(d_context, '00_data/csv_dat/id_decision_problems.csv', row.names = F)
...
write.table(xp_txt, '00_data/csv_dat/choice_problems_txt.csv',
            row.names = F,
            sep = ',',
            quote = T)